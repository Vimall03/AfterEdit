...
<body>
    ...
    <div class="p-5 mb-4 bg-white rounded-3">
        ...
        <h2 class="display-5 fw-bold text-center">Bills generated</h2>        
        <div class="container px-2">
                ...
                <table class="table table-hover table-responsive table-bordered border-dark">
                    <?php include 'partials/_dbconnect.php';
                                        ...
                                        <th scope="col">razorpay_signature</th>
                                        ...
                                        echo"<td>"; echo $row['Transaction_status']; echo "</td>";
                                        echo"<td>"; echo $row['razorpay_order_id']; echo "</td>"; 
                                        echo"<td>"; echo $row['razorpay_payment_id']; echo "</td>"; 
                                        echo"<td>"; echo $row['razorpay_signature']; echo "</td>"; 
