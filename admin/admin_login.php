...
//to check if the password/ email is blank
    if($ademail == '' || $adpassword == ''){
      ...
      //if not blank then go to else
        ...
        $sql = "select * FROM `admin_login`  where ademail = '$ademail' ";
          ...
          if($num==1){
            while ($row = mysqli_fetch_assoc($result)){
              ...
              if($adpassword == $row['adpassword']){
                ...
                $showError = "Invalid password / Email and password do not match";
              }
            }
          }
          else{
            $showError = "Invalid email / email not registered.";
          }
      }
  ...
  <div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      <div class="col-lg-7 text-center text-lg-start">
        <h1 class="display-4 fw-bold ">HELLO ADMIN</h1>
        <a class="col-lg-10 fs-4 text-center desc">Its nice to see you again. Login with your email and password </a><br><br>


      </div>
      <div class="col-md-10 mx-auto col-lg-5">
        <form action="/AfterEdit/admin/admin_login.php" method="post" class="p-4 p-md-5 border rounded-3 bg-light">
            
          <title>Bootstrap</title><span class="lglogo"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-alt "
            viewBox="0 0 16 16">
            <path
              d="M1 13.5a.5.5 0 0 0 .5.5h3.797a.5.5 0 0 0 .439-.26L11 3h3.5a.5.5 0 0 0 0-1h-3.797a.5.5 0 0 0-.439.26L5 13H1.5a.5.5 0 0 0-.5.5zm10 0a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5z" />
