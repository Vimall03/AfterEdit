...
//to check if the password/ email is blank
    if($email == '' || $password == ''){
      ...
      //if not blank then go to else
        ...
        $sql = "select * FROM lgin  where email = '$email' AND account_status = 'Verified'";
          ...
          if($num==1){
            while ($row = mysqli_fetch_assoc($result)){
              ...
              if(password_verify($password, $row['password'])){
                ...
                $sql = "select name from lgin  where email = '$email' ";
                $result = mysqli_query($conn, $sql);
    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-lg-5 py-5">
            <div class="col-lg-7 text-center text-lg-start">
                ...
                <a class="col-lg-10 fs-4 text-center desc">Its nice to see you again. Login with your email and password
                    to turn your ideas into reality. </a><br><br>
            ...
            <div class="col-md-10 mx-auto col-lg-5">
                <form action="/AfterEdit/login.php" method="post" class="p-4 p-md-5 border rounded-3 bg-light">
