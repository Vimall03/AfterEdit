...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if ($email == '' || $password == '') {
    ...
    $existSql = "SELECT * FROM lgin WHERE email = '$email' ";
    ...
    if ($numExistRows > 0){
      ...
      if ($password == $cpassword){
        ...
        $sql = "INSERT INTO lgin ( `name`, `email`, `password`, `dt`, `account_status`, `reset_code`) 
        ...
        $_SESSION["body"] = '<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
    <div style="margin:50px auto;width:70%;padding:20px 0">
      <div style="border-bottom:1px solid #eee">
        <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">afterEdit</a>
      </div>
      <p style="font-size:1.4em">Hi, '.$email.' </p>
      <p style="font-size:1.4em">Thank you for choosing afterEdit. Use the following OTP to complete your Sign Up process.</p>
      <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">'.$otp.'</h2>
      <p style="font-size:1.4em">Enter this code in our website to activate your account.</p>
      <p style="font-size:1.4em">If you have any questions, send us an email aftereditofficial@gmail.com</p>
      <p style="font-size:1.1em;">We\'re glad you\'re here!<br />The afterEdit team</p>
    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-lg-5 py-5">
            ...
            <div class="col-md-10 mx-auto col-lg-5">
                <form class="p-4 p-md-5 border rounded-3 bg-light" action="/AfterEdit/signup.php" method="post">
