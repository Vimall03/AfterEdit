<?php
//to make it accessible only when the user is logged in
session_start();
...
//$orderid = 'PORT'. random_int(10000, 99999);
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO `orders` (`Tran_status.`,`Date`, `Reg_email`, `Img_link`, `Slink`, `Contact`, `Instructions`, `Color_corr`, `Skin_ret`, `Level`, `Type`, `Order_id`, `Delivery_link`, `edit_status`,`base_fee`)
            VALUES ('$tranStatus',current_timestamp(), '{$_SESSION['email']}','$link', '$Slink', '$Cemail', '$instrc', '$color', '$skin', '$level', '$type', '$orderid', 'del_wait.php', 'Waiting confirmation', '299');";
...
<body class="">
    ...
    <div class="container">
        ...
        <div class="align-content-center m-auto">
            ...
            <form class="needs-validation" novalidate="" action="/AfterEdit/potrait_order.php" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="Slink" name="Slink" placeholder="" value="optional" minlength="5">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="instructions" rows="5" name="instructions" required inlength="25" maxlength="440"></textarea>
